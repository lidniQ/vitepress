<template>
  <button class="bold-text-bt" type="button" tabindex="-1" title="Жирный (Ctrl+B)" @click="boldText">
    <svg class="svg-button__icon" viewBox="0 0 20 20" width="16" height="16">
  ...
  methods: {
    ...
    boldText() {
      if (this.selectedText) {
        this.setTextarea(this.textarea.replace(this.selectedText, `**${this.selectedText}**`));
      }
    }
  }
};
